package neko.transaction.product.generate;
...
public class Generator {
    ...
    public void generate(){
        ...
        FastAutoGenerator.create("jdbc:mysql://192.168.30.131:3306/neko_transaction_product?" +
                ...
                .packageConfig(builder -> {
                    builder.parent("neko.transaction.product") // 设置父包名
                            .entity("entity")
                            .service("service")
