...
import neko.transaction.product.feign.member.UserRoleFeignService;
import neko.transaction.product.feign.member.UserWeightFeignService;
...
import neko.transaction.product.to.UserWeightTo;
import neko.transaction.product.vo.UpdateApiAuthInfoVo;
...
public class ApiAuthInfoServiceImpl extends ServiceImpl<ApiAuthInfoMapper, ApiAuthInfo> implements ApiAuthInfoService {
    ...
    public void synchronizeApiToDB() {
        ...
        String key = Constant.PRODUCT_REDIS_PREFIX + "api_auth_infos";
        //删除权限缓存
