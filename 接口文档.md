...
```bash
$baseUrl/member/user_weight/all_weight_infos
```
...
##### 1.3.6 根绝 权限id 获取权限信息

- get请求，url传参
- 建议只提供给微服务远程调用

```bash
$baseUrl/member/user_weight/user_weight_by_id
```
...
```bash
$baseUrl/member/user_weight/user_weight_by_id?weightId=1
```
...
```bash
$baseUrl/member/user_role/all_role_infos
```
...
##### 1.4.6 根据 角色id 获取角色信息

- get请求，url传参
- 建议只提供给微服务远程调用

```bash
$baseUrl/member/user_role/role_info_by_id
```
...
```bash
$baseUrl/member/user_role/role_info_by_id?roleId=1
```
...
#### 1.11 ApiAuthInfoController

##### 1.11.1 将 api 信息同步到数据库
...
```bash
$baseUrl/member/api_auth_info/synchronize_api_info_to_db
```
...
```bash
$baseUrl/member/api_auth_info/page_query
```
...
```json
{
    "result": {
        "records": [
            {
                "apiId": 48,
                "path": "/major_info/new_major_info",
                "requestMethod": "[POST]",
                "handlerMethod": "newMajorInfo",
                "weightId": null,
                "weight": null,
                "roleId": null,
                "role": null,
                "createTime": "2024-05-19T14:40:58",
                "updateTime": "2024-05-19T14:40:58"
            },
            {
                "apiId": 47,
                "path": "/major_info/major_info_page_query",
                "requestMethod": "[POST]",
                "handlerMethod": "majorInfoPageQuery",
                "weightId": null,
                "weight": null,
                "roleId": null,
                "role": null,
            ...
            {
                "apiId": 46,
                "path": "/class_info/new_class_info",
                "requestMethod": "[PUT]",
                "handlerMethod": "newClassInfo",
                "weightId": null,
                "weight": null,
                "roleId": null,
                "role": null,
            ...
            {
                "apiId": 45,
                "path": "/user_role/role_info",
                "requestMethod": "[POST]",
                "handlerMethod": "roleInfo",
                "weightId": null,
                "weight": null,
                "roleId": null,
                "role": null,
            ...
            {
                "apiId": 44,
                "path": "/college_info/delete_by_id",
            ...
            {
                "apiId": 43,
                "path": "/member_chat_info/user_self_chatting_with_page_query",
                "requestMethod": "[POST]",
                "handlerMethod": "userSelfChattingWithPageQuery",
                "weightId": null,
                "weight": null,
                "roleId": null,
                "role": null,
            ...
            {
                "apiId": 42,
                "path": "/member_info/user_self_info",
                "requestMethod": "[GET]",
                "handlerMethod": "userSelfInfo",
                "weightId": null,
                "weight": null,
                "roleId": null,
                "role": null,
            ...
            {
                "apiId": 41,
                "path": "/member_info/uid_login",
                "requestMethod": "[POST]",
                "handlerMethod": "uidLogIn",
                "weightId": null,
                "weight": null,
                "roleId": null,
                "role": null,
...
```bash
$baseUrl/member/api_auth_info/update_api_auth_info
```
...
```bash
$baseUrl/product/product_info/synchronize_product_info_to_es
```
...
```bash
$baseUrl/product/order_detail_info/seller_censor_return_apply
```
...
```bash
$baseUrl/product/order_detail_info/admin_censor_return_apply
```
...
```bash
$baseUrl/product/order_detail_info/confirm_return_cargo_sent_back
```
...
```bash
$baseUrl/product/order_detail_info/confirm_return_cargo_sent_back?applyId=1
```
...
```bash
$baseUrl/product/accusation_type/new_accusation_type
```
...
```bash
$baseUrl/product/accusation_type/accusation_type_page_query
```
        ...
        "records": [
            {
                ...
                "accuseType": "NEKO_6",
                "sort": 21,
                "createTime": "2024-04-22T10:36:43",
                "updateTime": "2024-04-22T10:36:43"
            },
            {
                "accuseTypeId": 7,
                "accuseType": "NEKO_5",
                "sort": 20,
                "createTime": "2024-04-22T10:36:37",
                "updateTime": "2024-04-22T10:36:37"
            },
            {
                "accuseTypeId": 6,
                "accuseType": "NEKO_4",
                "sort": 19,
                "createTime": "2024-04-22T10:36:28",
                "updateTime": "2024-04-22T10:36:28"
            },
            {
                "accuseTypeId": 5,
                "accuseType": "NEKO_3",
                "sort": 18,
                "createTime": "2024-04-22T10:36:21",
                "updateTime": "2024-04-22T10:36:21"
            },
            {
                "accuseTypeId": 4,
                "accuseType": "NEKO_2",
                "sort": 17,
                "createTime": "2024-04-22T10:36:14",
                "updateTime": "2024-04-22T10:36:14"
            },
            {
                "accuseTypeId": 2,
                "accuseType": "NEKO_1",
                "sort": 15,
                "createTime": "2024-04-22T10:35:58",
                "updateTime": "2024-04-22T10:35:58"
            },
            {
                "accuseTypeId": 1,
                "accuseType": "NEKO",
                "sort": 15,
                "createTime": "2024-04-22T10:35:52",
                "updateTime": "2024-04-22T10:35:52"
            }
        ],
        "total": 7,
        "size": 8,
...
```bash
$baseUrl/product/accusation_type/update_accusation_type
```
...
```bash
$baseUrl/product/accusation_type/delete_accusation_type
```
...
```bash
$baseUrl/product/accusation_type/delete_accusation_type?accuseTypeId=2
```
...
```bash
$baseUrl/product/accusation_type/all_accusation_type
```
    ...
    "result": [
        {
            ...
            "accuseType": "商品质量过差",
            "sort": 3,
            "createTime": "2024-04-22T12:22:45",
            "updateTime": "2024-04-22T12:22:50"
        },
        {
            "accuseTypeId": 3,
            "accuseType": "商品欺诈",
            "sort": 2,
            "createTime": "2024-04-22T12:17:00",
            "updateTime": "2024-04-22T12:17:00"
        },
        {
            "accuseTypeId": 2,
            "accuseType": "违规商品",
            "sort": 1,
            "createTime": "2024-04-22T12:15:57",
            "updateTime": "2024-04-22T12:15:57"
        },
        {
            "accuseTypeId": 1,
            "accuseType": "恶意定价",
            "sort": 0,
            "createTime": "2024-04-22T12:15:05",
            "updateTime": "2024-04-22T12:15:05"
        },
        {
            "accuseTypeId": 4,
            "accuseType": "其他",
            "sort": -5000,
            "createTime": "2024-04-22T12:17:33",
            "updateTime": "2024-04-22T12:17:39"
        }
    ],
    "responseStatus": "SUCCESS",
    "responseCode": 200,
...
```bash
$baseUrl/product/accusation_info/new_accusation_info
```
...
```bash
$baseUrl/product/accusation_info/unhandled_accusation_info_page_query
```
        ...
        "records": [
            {
                ...
                "productId": "1779335044930809857",
                "description": "NEKO",
                "informerUid": "1642067605873348610",
                "operationAdminId": null,
                "status": 0,
                "accuseType": "其他",
                "productName": "图解Java设计模式",
                "createTime": "2024-04-22T14:34:58",
                "updateTime": "2024-04-22T14:34:58"
            },
            {
                "accuseId": 2,
                "accuseTypeId": 4,
                ...
                "accuseType": "其他",
                "productName": "图解Java设计模式",
                "createTime": "2024-04-23T15:36:35",
                "updateTime": "2024-04-23T15:36:35"
            }
        ],
        "total": 2,
        "size": 8,
...
```bash
$baseUrl/product/accusation_info/reject_accusation
```
...
```bash
$baseUrl/product/accusation_info/reject_accusation?accuseId=1
```
...
```bash
$baseUrl/product/accusation_info/pass_accusation
```
...
```bash
$baseUrl/product/accusation_info/pass_accusation?accuseId=1
```
...
```bash
$baseUrl/product/accusation_info/ban_reason_by_product_id
```
...
```bash
$baseUrl/product/accusation_info/ban_reason_by_product_id?productId=1779335044930809857
```
...
#### 2.13 ApiAuthInfoController

##### 2.13.1 将 api 信息同步到数据库
...
```bash
$baseUrl/product/api_auth_info/synchronize_api_info_to_db
```
...
```bash
$baseUrl/product/api_auth_info/page_query
```
...
```bash
$baseUrl/product/api_auth_info/update_api_auth_info
```
...
#### 4.2 ApiAuthInfoController

##### 4.2.1 将 api 信息同步到数据库
