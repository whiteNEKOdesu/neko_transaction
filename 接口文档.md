...
```bash
$baseUrl/product/product_image/page_query_by_id
```
...
```bash
$baseUrl/product/product_image/page_query_by_id?productId=1748171551460679681
```
    ...
    "result": [
        {
            ...
            "createTime": "2024-01-19T10:32:41",
            "updateTime": "2024-01-19T10:32:41"
        }
    ],
    "responseStatus": "SUCCESS",
    "responseCode": 200,
